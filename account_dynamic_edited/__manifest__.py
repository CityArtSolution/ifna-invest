# -*- coding: utf-8 -*-
{
    'name': 'Edited - All in one Dynamic Financial Reports v14',
    'version': '14.1.0',
    ...
    'assets': {
        ...
        'web.assets_backend': [
            'account_dynamic_edited/static/src/js/select2.full.min.js',
            'account_dynamic_edited/static/src/js/script.js',
            'account_dynamic_edited/static/src/scss/dynamic_common_style.scss'
        ]},
