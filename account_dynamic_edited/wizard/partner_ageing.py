...
class InsPartnerAgeing(models.TransientModel):
    ...
    def print_xls(self):
        ...
        data = {'company_id': self.company_id, 'as_on_date': as_on_date}
        return self.env.ref('account_dynamic_edited.action_ins_partner_ageing_xlsx').report_action(self, data=data)
