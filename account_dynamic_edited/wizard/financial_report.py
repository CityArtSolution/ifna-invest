...
class InsFinancialReport(models.TransientModel):
    ...
    def _compute_account_balance(self, accounts, report):
        ...
        if accounts:
            if self.account_report_id != \
                    self.env.ref(
                        'account_dynamic_edited.ins_account_financial_report_cash_flow0') and self.strict_range:
    ...
    def _compute_report_balance(self, reports):
        ...
        for report in reports:
            ...
            if report.type == 'accounts':
                ...
                if self.account_report_id != \
                        self.env.ref('account_dynamic_edited.ins_account_financial_report_cash_flow0'):
                    ...
                    for key, value in res2.items():
                        if report in [self.env.ref('account_dynamic_edited.ins_cash_in_operation_1'),
                                      self.env.ref('account_dynamic_edited.ins_cash_in_investing_1'),
                                      self.env.ref('account_dynamic_edited.ins_cash_in_financial_1')]:
                ...
                if self.account_report_id != \
                    ...
                    if report == self.env.ref('account_dynamic_edited.ins_account_financial_report_cash_flow0'):
    ...
    def get_report_values(self):
        ...
        if self.account_report_id == \
            ...
            data['form']['rtype'] = 'CASH'
                ...
                self.env.ref('account_dynamic_edited.ins_account_financial_report_profitandloss0'):
    ...
    def _get_default_report_id(self):
        ...
        return self.env.ref('account_dynamic_edited.ins_account_financial_report_profitandloss0').id
    ...
    def action_pdf(self):
        ...
        return self.env.ref(
            'account_dynamic_edited.ins_financial_report_pdf').report_action(self,
                                                                             data)
    ...
    def print_xls(self):
        ...
        data = {'report_name': report, 'account_report_id': self.account_report_id, 'from_date': date_from,
                'to_date': date_to}
        return self.env.ref('account_dynamic_edited.action_ins_financial_report_xlsx').report_action(self, data=data)
    ...
    #     datestring = fields.Date.from_string(str(data['form']['date_from'] and data['form']['date_from'])).strftime(
    #         lang_id.date_format)
    ...
    #             str(data['form']['comparison_context']['date_from'] and data['form']['comparison_context'][
