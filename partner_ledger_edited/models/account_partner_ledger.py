...
class ReportPartnerLedger(models.AbstractModel):
    ...
    _name = "account.partner.ledger.new"
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'partner_ledger_edited.line_template_partner_ledger_report_new'
        templates['main_template'] = 'partner_ledger_edited.main_template_with_filter_input_partner_new'
        return templates
